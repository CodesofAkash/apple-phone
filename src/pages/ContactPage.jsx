              ...
              <div className="order-2 lg:order-1">
                ...
                >
                    ...
                    <div className="form-field opacity-0 translate-y-10 group">
                      <label htmlFor="name" className="block text-sm font-semibold text-gray-300 mb-3 group-focus-within:text-blue-400 transition-colors">
                        Your Name
                      </label>
                    ...
                    {/* Email Field */}
                    <div className="form-field opacity-0 translate-y-10 group">
                      <label htmlFor="email" className="block text-sm font-semibold text-gray-300 mb-3 group-focus-within:text-purple-400 transition-colors">
                        Email Address
                      </label>
                      <div className="relative">
                        <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                    ...
                    {/* Subject Field */}
                    <div className="form-field opacity-0 translate-y-10 group">
                      <label htmlFor="subject" className="block text-sm font-semibold text-gray-300 mb-3 group-focus-within:text-pink-400 transition-colors">
                        Subject
                      </label>
                      <div className="relative">
                        <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                    ...
                    {/* Message Field */}
                    <div className="form-field opacity-0 translate-y-10 group">
                      <label htmlFor="message" className="block text-sm font-semibold text-gray-300 mb-3 group-focus-within:text-blue-400 transition-colors">
                        Your Message
                      </label>
                      <div className="relative">
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <div className="flex gap-3 mt-3">
                        <a href="#" className="p-2 bg-zinc-800 hover:bg-zinc-700 rounded-lg transition-all">
